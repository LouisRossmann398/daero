...
export type LegalBlock =
  ...
  | { type: "contact"; phone: string; phoneHref: string; email: string }
    ...
    subsections: [
      {
        ...
        blocks: [
          ...
          {
            type: "address",
            lines: ["OVH GmbH", "Christophstraße 19", "50670 Köln", "Deutschland"],
          },
        ],
      },
    ],
